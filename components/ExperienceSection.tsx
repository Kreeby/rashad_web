    ...
    () => [
      {
        ...
        lat: 47.4979,
        lng: 19.0402,
        company: "bp (Mobility & Convenience)",
        role: "Head of Loyalty Platform Technology - Product, Engineering & Operations",
        period: "06/2025 - Present",
        achievements: [
          "Owning bp’s global Loyalty Platform strategy & delivery",
          "Leading Product, Engineering, and Vendor teams across 7+ regions",
          "Managing CAPEX/OPEX budgets, KPIs, and global rollouts (US, EU, ANZ, SA, MX)",
        ],
        type: "work",
        size: "large",
      },
